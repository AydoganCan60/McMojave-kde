...
Item {
    ...
    MouseArea {
            ...
            initialItem: Login {
                ...
                notificationMessage: {
                    ...
                    if (capsLockState.locked) {
                        parts.push(i18nd("plasma-desktop-sddm-theme", "Caps Lock açık"));
                    }
                ...
                actionItems: [
                    ActionButton {
                        ...
                        text: i18ndc("plasma-desktop-sddm-theme", "RAM'e askıya al", "Uyku")
                        onClicked: sddm.suspend()
                        enabled: sddm.canSuspend
                    },
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/McMojave/assets/restart_primary.svgz"
                        text: i18nd("plasma-desktop-sddm-theme", "Yeniden başlat")
                        onClicked: sddm.reboot()
                        enabled: sddm.canReboot
                    },
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/McMojave/assets/shutdown_primary.svgz"
                        text: i18nd("plasma-desktop-sddm-theme", "Kapat")
                        onClicked: sddm.powerOff()
                        enabled: sddm.canPowerOff
                    },
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/McMojave/assets/switch_primary.svgz"
                        text: i18ndc("plasma-desktop-sddm-theme", "Kullanıcı adı ve şifre ile giriş yapmak için", "Diğer...")
            ...
            Login {
                ...
                userListModel: ListModel {
                    ...
                    Component.onCompleted: {
                        ...
                        setProperty(0, "name", i18nd("plasma-desktop-sddm-theme", "Kullanıcı adı ve şifre ile giriş yapmak için"));
                ...
                actionItems: [
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/McMojave/assets/switch_primary.svgz"
                        text: i18nd("plasma-desktop-sddm-theme", "Kullanıcıları listele")
        ...
        RowLayout {
            ...
            PlasmaComponents3.ToolButton {
                ...
                text: i18ndc("plasma-desktop-sddm-theme", "Button to show/hide virtual keyboard", "Sanal klavye")
    ...
    Connections {
        ...
        function onLoginFailed() {
            notificationMessage = i18nd("plasma-desktop-sddm-theme", "Giriş başarısız oldu!")
            footer.enabled = true
